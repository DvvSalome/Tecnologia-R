...
const MapSection = () => {
  ...
  return (
    <div className="w-full px-4 py-10" data-aos="fade-up">
      {/* Title */}
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 mb-3">
          <FiMapPin className="w-5 h-5 text-primary-500" />
          <h2 className="text-3xl font-bold text-surface-800 dark:text-surface-100">
            Ubicanos
          </h2>
        </div>
      ...
      {/* Map */}
      <div className="rounded-3xl overflow-hidden shadow-card border border-surface-200 dark:border-surface-700/50 max-w-5xl mx-auto">
        <iframe
